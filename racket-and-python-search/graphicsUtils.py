...
if sys.version_info[0] == 2:
    import Tkinter
    tkinter_obj = Tkinter.tkinter
    dooneevent = tkinter_obj.dooneevent
else:
    import tkinter as Tkinter
    tkinter_obj = Tkinter._tkinter
    dooneevent = None
import os.path
...
def begin_graphics(width=640, height=480, color=formatColor(0, 0, 0), title=None):
    ...
    global _root_window, _canvas, _canvas_x, _canvas_y, _canvas_xs, _canvas_ys, _bg_color, dooneevent
    ...
    if sys.version_info[0] == 3:
        dooneevent = _root_window.tk.dooneevent
...
def keys_pressed(d_w=tkinter_obj.DONT_WAIT):
    dooneevent(d_w)
    if _got_release:
        dooneevent(d_w)
...
def move_by(object, x, y=None,
            d_w=tkinter_obj.DONT_WAIT, lift=False):
    if y is None:
        try: x, y = x
